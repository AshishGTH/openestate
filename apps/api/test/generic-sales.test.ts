...
describeIf('generic-sales plugin (Phase 7 commit 3)', () => {
  ...
  beforeAll(async () => {
    ...
    const inquiryService = new InquiryService(tenantPrisma, systemPrisma, SYSTEM_CLOCK, assignmentService, applicantService, new CustomFieldsService(tenantPrisma, systemPrisma), new LeadStageTransitionService());
