...
/** Reached via the code an admin's "force password reset" sends: /reset-password?token=... */
        ...
        <div className="rounded-lg border border-slate-200 bg-white p-6 shadow-sm">
          ...
          {!token && (
            <p className="mt-4 text-sm text-amber-700 text-center">
              This link is missing its reset code. Ask an administrator to send a new one.
            </p>
          )}
