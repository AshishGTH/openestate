...
As of v0.8.0, the core sales funnel — auth/RBAC, multi-tenancy, inventory
...
to end. v0.8.0 adds a safety net against accidentally storing Aadhaar
numbers in custom fields — deterrence, not prevention; v0.7.1 is a security fix to the audit log — most create, update
