...
> **Status: v0.6.0 — the core sales funnel works end to end for a first
...
> exercised end to end in a real browser against a real install. v0.6.0
> adds admin-issued, one-time password-reset links for staff and portal
...
versioning (v0.1.0 → v0.6.0 and counting) since — manager-hierarchy lead
